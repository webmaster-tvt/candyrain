<?php
/**
 * Catch Inspire Theme Options Sanitization Functions
 *
 ...
 */
function catch_inspire_sanitize_select( $input, $setting ) {
 ...
 */
function catch_inspire_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function catch_inspire_sanitize_post( $input ) {
 ...
 */
function catch_inspire_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function catch_inspire_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function catch_inspire_sanitize_number_range( $number, $setting ) {
